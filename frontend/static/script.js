...
<button onclick="setIndivRgb('${item.key}','blue')">Blue</button>
<button onclick="setIndivRgb('${item.key}','purple')">Purple</button>
<button onclick="setIndivRgb('${item.key}','cyan')">Cyan</button>
<button onclick="setIndivRgb('${item.key}','white')">White</button>
<button onclick="setIndivRgb('${item.key}','green')">Green</button>
</div> 
...
// Actuator ON/OFF button highlighting
